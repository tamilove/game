var Game = function(answer, guess) {
  ...
  this.gameOn = function() {
    ...
    guess = parseInt(prompt("I would like you to guess the minimum number of people needed in a room to have a probabilty of 90% that two people have the same birthdate. Remember, you don't really need to know the answer; just guess."));
console.log(guess);
    while (guess != answer){
      ...
      document.getElementById("congrats").innerHTML = "You obviously know what you are doing!"
